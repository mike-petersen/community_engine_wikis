# Add CE Wikis routes
route "map.routes_from_plugin :community_engine_wikis"
...
# Success!
puts "SUCCESS!"
puts "Next, you should probably run `rake test` and `rake community_engine_wikis:test` and make sure all tests pass. "